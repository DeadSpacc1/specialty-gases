(function ($) {
 ...
 // RANGE SLIDER
  ...
  var swiper = new Swiper('#serviceSliderOne', {
    slidesPerView: 4,
    spaceBetween: 24,
    pagination: {
      el: '.swiper-pagination',
  ...
  // SLIDER
  var mainslider = new Swiper('.banner-slider', {
    spaceBetween: 0,
    autoplay: {
      delay: 9500,
  ...
  equalheight = function(container){
    ...
    $(window).load(function() {
      equalheight('.service-card');
      equalheight('.service-one--page .service-one__item');
      equalheight('.contact-info__card');
    });
    ...
    $('.testimonials-two__carousel').slick({
      dots: true,
      arrows:false,
      // infinite: true,
      // autoplay: true,
